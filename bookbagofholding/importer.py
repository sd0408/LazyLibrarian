...
from bookbagofholding.formatter import today, unaccented, formatAuthorName, makeUnicode
...
def addAuthorNameToDB(author=None, refresh=False, addbooks=True):
    ...
    if not check_exist_author and bookbagofholding.CONFIG['ADD_AUTHOR']:
...
def addAuthorToDB(authorname=None, refresh=False, authorid=None, addbooks=True):
    ...
    try:
        ...
        if dbauthor:
            ...
            entry_status = bookbagofholding.CONFIG['NEWAUTHOR_STATUS']
            new_author = True
        ...
        if addbooks:
            if new_author:
                bookstatus = bookbagofholding.CONFIG['NEWAUTHOR_STATUS']
                audiostatus = bookbagofholding.CONFIG['NEWAUTHOR_AUDIO']
            else:
