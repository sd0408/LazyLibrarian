...
def _login(hosturl):
    ...
    params = {
        ...
        "version": "2",
        "method": "login",
        "account": bookbagofholding.CONFIG['SYNOLOGY_USER'],
        "passwd": bookbagofholding.CONFIG['SYNOLOGY_PASS'],
        "session": "Bookbag of Holding",
        "format": "sid"
    }
...
def _addTorrentURI(task_cgi, sid, torurl):
    ...
    params = {
        ...
        "session": "Bookbag of Holding",
        "uri": torurl,
        "destination": bookbagofholding.CONFIG['SYNOLOGY_DIR'],
        "_sid": sid
    }
...
def _hostURL():
    ...
    host = bookbagofholding.CONFIG['SYNOLOGY_HOST']
    port = check_int(bookbagofholding.CONFIG['SYNOLOGY_PORT'], 0)
