...
from bookbagofholding.common import csv_file, safe_move
from bookbagofholding.formatter import plural, is_valid_isbn, now, unaccented, formatAuthorName, \
    makeUnicode, split_title, makeBytestr
from bookbagofholding.importer import search_for, import_book, addAuthorNameToDB
...
def import_CSV(search_dir=None, library='eBook'):
    ...
    try:
        ...
        if not csvFile:
                ...
                if csvreader.line_num == 1:
                    ...
                    if authmatch:
                        ...
                        newauthor, authorid, new = addAuthorNameToDB(author=authorname,
                                                                     addbooks=bookbagofholding.CONFIG['NEWAUTHOR_BOOKS'])
            ...
            logger.info(msg)
            if bookbagofholding.CONFIG['DELETE_CSV']:
                if skipcount == 0:
