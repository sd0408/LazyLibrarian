...
from bookbagofholding.common import (
...
from bookbagofholding.postprocess import processDir

# TODO: magazineScan module not yet implemented
magazineScan = None
...
class SystemApi(ApiBase):
    ...
    def get_logs(self, **kwargs) -> Dict[str, Any]:
        ...
        Returns:
            Log entries
        """
        logfile = os.path.join(bookbagofholding.CONFIG['LOGDIR'], 'bookbagofholding.log')
    ...
    def read_cfg(self, **kwargs) -> Dict[str, Any]:
        ...
        configfile = bookbagofholding.CONFIGFILE
    ...
    def write_cfg(self, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            if name in bookbagofholding.CONFIG:
                bookbagofholding.CONFIG[name] = value
