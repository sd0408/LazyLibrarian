...
from bookbagofholding import sabnzbd, nzbget
from bookbagofholding.classes import NZBSearchResult, NZBDataSearchResult
...
def sab_config():
    ...
    bookbagofholding.CONFIG['SAB_HOST'] = 'localhost'
    bookbagofholding.CONFIG['SAB_PORT'] = '8080'
    bookbagofholding.CONFIG['SAB_API'] = 'test-api-key-12345'
    bookbagofholding.CONFIG['SAB_USER'] = ''
    bookbagofholding.CONFIG['SAB_PASS'] = ''
    bookbagofholding.CONFIG['SAB_CAT'] = 'books'
    bookbagofholding.CONFIG['SAB_SUBDIR'] = ''
    bookbagofholding.CONFIG['HTTP_TIMEOUT'] = '30'
    bookbagofholding.CONFIG['USENET_RETENTION'] = ''
...
def nzbget_config():
    ...
    bookbagofholding.CONFIG['NZBGET_HOST'] = 'localhost'
    bookbagofholding.CONFIG['NZBGET_PORT'] = '6789'
    bookbagofholding.CONFIG['NZBGET_USER'] = 'nzbget'
    bookbagofholding.CONFIG['NZBGET_PASS'] = 'tegbzn6789'
    bookbagofholding.CONFIG['NZBGET_CATEGORY'] = 'books'
    bookbagofholding.CONFIG['NZBGET_PRIORITY'] = '0'
    bookbagofholding.LOGLEVEL = 0
...
class TestSABnzbdCheckLink:
    ...
    @patch('bookbagofholding.sabnzbd.SABnzbd')
    ...
    def test_checkLink_invalid_category(self, mock_sab, sab_config):
        ...
        bookbagofholding.CONFIG['SAB_CAT'] = 'nonexistent'
        mock_sab.side_effect = [
            ({'auth': 'apikey'}, ''),
...
class TestSABnzbdFunction:
    ...
    def test_SABnzbd_invalid_host(self, sab_config):
        ...
        bookbagofholding.CONFIG['SAB_HOST'] = ''
    ...
    @patch('bookbagofholding.sabnzbd.requests.get')
    def test_SABnzbd_zero_port_uses_host_only(self, mock_get, sab_config):
        ...
        bookbagofholding.CONFIG['SAB_PORT'] = 0
        mock_response = Mock()
    ...
    def test_SABnzbd_with_subdir(self, mock_get, sab_config):
        ...
        bookbagofholding.CONFIG['SAB_SUBDIR'] = 'sabnzbd'
        mock_response = Mock()
        mock_response.json.return_value = {'status': True, 'nzo_ids': ['id123']}
        mock_get.return_value = mock_response
    ...
    def test_SABnzbd_with_https(self, mock_get, sab_config):
        ...
        bookbagofholding.CONFIG['SAB_HOST'] = 'https://localhost'
        mock_response = Mock()
        mock_response.json.return_value = {'status': True, 'nzo_ids': ['id123']}
        mock_get.return_value = mock_response
...
class TestNZBgetCheckLink:
    ...
    @patch('bookbagofholding.nzbget.sendNZB')
...
class TestNZBgetSendNZB:
    ...
    def test_sendNZB_invalid_host(self, nzbget_config):
        ...
        bookbagofholding.CONFIG['NZBGET_HOST'] = ''
    ...
    def test_sendNZB_invalid_port(self, nzbget_config):
        ...
        bookbagofholding.CONFIG['NZBGET_PORT'] = 'notaport'
    ...
    @patch('bookbagofholding.nzbget.xmlrpc_client.ServerProxy')
