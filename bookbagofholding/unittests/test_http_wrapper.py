...
class TestHTTPClientWrapper:
    ...
    @patch('bookbagofholding.clients.http_wrapper.requests.get')
    @patch('bookbagofholding.clients.http_wrapper.proxyList')
    ...
    @patch('bookbagofholding.clients.http_wrapper.requests.post')
    @patch('bookbagofholding.clients.http_wrapper.proxyList')
