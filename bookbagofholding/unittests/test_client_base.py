...
def setup_test_config():
    ...
    original_config = bookbagofholding.CONFIG.copy()
    bookbagofholding.CONFIG['TEST_HOST'] = 'localhost'
    bookbagofholding.CONFIG['TEST_PORT'] = '8080'
    bookbagofholding.CONFIG['TEST_USER'] = 'testuser'
    bookbagofholding.CONFIG['TEST_PASS'] = 'testpass'
    bookbagofholding.CONFIG['TEST_HTTPS'] = False
...
def setup_nzb_config():
    ...
    original_config = bookbagofholding.CONFIG.copy()
    bookbagofholding.CONFIG['TESTNZB_HOST'] = 'localhost'
    bookbagofholding.CONFIG['TESTNZB_PORT'] = '8080'
    bookbagofholding.CONFIG['TESTNZB_CAT'] = 'books'
    bookbagofholding.CONFIG['TESTNZB_API'] = 'abc123'
    bookbagofholding.CONFIG['HTTP_TIMEOUT'] = 30
    yield
    bookbagofholding.CONFIG.clear()
    bookbagofholding.CONFIG.update(original_config)
...
def setup_torrent_config():
    ...
    original_config = bookbagofholding.CONFIG.copy()
    bookbagofholding.CONFIG['TESTTOR_HOST'] = 'localhost'
    bookbagofholding.CONFIG['TESTTOR_PORT'] = '9091'
    bookbagofholding.CONFIG['TESTTOR_LABEL'] = 'books'
    bookbagofholding.CONFIG['TESTTOR_DIR'] = '/downloads/books'
    bookbagofholding.CONFIG['SEED_WAIT'] = True
    bookbagofholding.CONFIG['HTTP_TIMEOUT'] = 30
    yield
    bookbagofholding.CONFIG.clear()
    bookbagofholding.CONFIG.update(original_config)
...
class TestDownloadClient:
    ...
    def test_get_config_int_invalid(self):
        ...
        original = bookbagofholding.CONFIG.copy()
        bookbagofholding.CONFIG['TEST_HOST'] = 'localhost'
        bookbagofholding.CONFIG['TEST_PORT'] = 'invalid'
        bookbagofholding.CONFIG['HTTP_TIMEOUT'] = 30
        try:
            client = ConcreteDownloadClient()
            ...
            bookbagofholding.CONFIG.clear()
            bookbagofholding.CONFIG.update(original)
    ...
    def test_base_url_with_https(self):
        ...
        bookbagofholding.CONFIG['TEST_HOST'] = 'localhost'
        bookbagofholding.CONFIG['TEST_PORT'] = '8080'
        bookbagofholding.CONFIG['TEST_HTTPS'] = True
        bookbagofholding.CONFIG['HTTP_TIMEOUT'] = 30
        try:
            client = ConcreteDownloadClient()
    ...
    def test_validate_config_missing_host(self):
        ...
        original = bookbagofholding.CONFIG.copy()
        bookbagofholding.CONFIG['TEST_HOST'] = ''
        bookbagofholding.CONFIG['TEST_PORT'] = '8080'
        bookbagofholding.CONFIG['HTTP_TIMEOUT'] = 30
        try:
            client = ConcreteDownloadClient()
    ...
    def test_validate_config_missing_port(self):
        ...
        original = bookbagofholding.CONFIG.copy()
        bookbagofholding.CONFIG['TEST_HOST'] = 'localhost'
        bookbagofholding.CONFIG['TEST_PORT'] = '0'
        bookbagofholding.CONFIG['HTTP_TIMEOUT'] = 30
        try:
            client = ConcreteDownloadClient()
            is_valid, error = client.validate_config()
...
class TestNzbClient:
    ...
    def test_api_key_fallback(self):
        ...
        bookbagofholding.CONFIG['TESTNZB_HOST'] = 'localhost'
        bookbagofholding.CONFIG['TESTNZB_PORT'] = '8080'
        bookbagofholding.CONFIG['TESTNZB_APIKEY'] = 'fallback123'
        bookbagofholding.CONFIG['HTTP_TIMEOUT'] = 30
        try:
            client = ConcreteNzbClient()
...
class TestTorrentClient:
    ...
    def test_label_fallback_to_cat(self):
        ...
        bookbagofholding.CONFIG['TESTTOR_HOST'] = 'localhost'
        bookbagofholding.CONFIG['TESTTOR_PORT'] = '9091'
        bookbagofholding.CONFIG['TESTTOR_CAT'] = 'category'
        bookbagofholding.CONFIG['HTTP_TIMEOUT'] = 30
        try:
            client = ConcreteTorrentClient()
