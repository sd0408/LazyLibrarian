...
"""
Unit tests for bookbagofholding.cache module.
...
from bookbagofholding import cache
from bookbagofholding.formatter import md5_utf8


@pytest.fixture
def cache_setup():
    """Set up cache directory for testing."""
    original_cachedir = getattr(bookbagofholding, 'CACHEDIR', None)
    original_cache_age = bookbagofholding.CONFIG.get('CACHE_AGE', 30)

    with tempfile.TemporaryDirectory() as tmpdir:
        bookbagofholding.CACHEDIR = tmpdir
        bookbagofholding.CONFIG['CACHE_AGE'] = 30  # 30 days
    ...
    bookbagofholding.CACHEDIR = original_cachedir
    bookbagofholding.CONFIG['CACHE_AGE'] = original_cache_age


class TestFetchURL:
    """Tests for fetchURL() function."""

    @patch('bookbagofholding.cache.requests.get')
...
class TestCacheImg:
    ...
    @patch('bookbagofholding.cache.fetchURL')
...
class TestGetCachedRequest:
    ...
    def test_get_cached_request_expired_cache(self, cache_setup):
        ...
        with patch('bookbagofholding.cache.fetchURL') as mock_fetch:
...
class TestGbJsonRequest:
    ...
    @patch('bookbagofholding.cache.get_cached_request')
...
class TestCacheStatistics:
    ...
    def test_cache_hit_increments(self, cache_setup):
        ...
        original_hits = bookbagofholding.CACHE_HIT
