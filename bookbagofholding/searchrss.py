...
from bookbagofholding.csvfile import finditem
from bookbagofholding.formatter import plural, unaccented, formatAuthorName, check_int
from bookbagofholding.importer import import_book, search_for
from bookbagofholding.providers import IterateOverRSSSites, IterateOverWishLists
from bookbagofholding.resultlist import processResultList
            ...
            if book['rss_bookid']:
                ...
                if bookmatch:  # it's already in the database
                    ...
                    if results:
                        ...
                        if result['isbn_fuzz'] > check_int(bookbagofholding.CONFIG['MATCH_RATIO'], 90):
                    ...
                    if results:
                        result = results[0]  # type: dict
                        if result['author_fuzz'] > check_int(bookbagofholding.CONFIG['MATCH_RATIO'], 90) \
                                and result['book_fuzz'] > check_int(bookbagofholding.CONFIG['MATCH_RATIO'], 90):
...
def search_rss_book(books=None, library=None):
    ...
    """
    if not (bookbagofholding.USE_RSS()):
