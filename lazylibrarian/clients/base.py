...
from lazylibrarian.utils.url_builder import URLBuilder
...
class DownloadClient(ABC):
    ...
    - Configuration loading from lazylibrarian.CONFIG
...
class TorrentClient(DownloadClient):
    ...
    def should_wait_for_seeding(self):
        ...
        """
        return bool(lazylibrarian.CONFIG.get('SEED_WAIT', False))
