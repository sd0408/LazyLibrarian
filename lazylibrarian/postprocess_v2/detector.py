...
"""
File type detection for LazyLibrarian post-processing.
...
class FileDetector:
    ...
    def get_ebook_extensions() -> List[str]:
        ...
        """
        extensions = getList(lazylibrarian.CONFIG.get('EBOOK_TYPE', 'epub,mobi,pdf'))
    ...
    def get_audiobook_extensions() -> List[str]:
        ...
        """
        extensions = getList(lazylibrarian.CONFIG.get('AUDIOBOOK_TYPE', 'mp3,m4a,m4b'))
        return ['.' + ext.lower().lstrip('.') for ext in extensions if ext]
    ...
    def get_magazine_extensions() -> List[str]:
        ...
        """
        extensions = getList(lazylibrarian.CONFIG.get('MAG_TYPE', 'pdf,epub'))
        return ['.' + ext.lower().lstrip('.') for ext in extensions if ext]
