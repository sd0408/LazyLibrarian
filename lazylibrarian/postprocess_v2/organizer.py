...
"""
File organization for LazyLibrarian post-processing.
...
class FileOrganizer:
    ...
    def get_destination_folder(author_name: str, book_title: str,
        ...
        if library == 'AudioBook':
            base_dir = lazylibrarian.DIRECTORY('AudioBook')
            pattern = lazylibrarian.CONFIG.get('AUDIOBOOK_DEST_FOLDER', '$Author/$Title')
        else:
            base_dir = lazylibrarian.DIRECTORY('eBook')
            pattern = lazylibrarian.CONFIG.get('EBOOK_DEST_FOLDER', '$Author/$Title')
    ...
    def get_destination_filename(author_name: str, book_title: str,
        ...
        """
        if library == 'AudioBook':
            pattern = lazylibrarian.CONFIG.get('AUDIOBOOK_DEST_FILE', '$Title')
        else:
            pattern = lazylibrarian.CONFIG.get('EBOOK_DEST_FILE', '$Title')
    ...
    def move_file(cls, source: str, dest_dir: str,
        ...
        # Move the file
        try:
            if lazylibrarian.CONFIG.get('DESTINATION_COPY', False):
